...
CUDA_VISIBLE_DEVICES=2 nnUNet_def_n_proc=3 nnUNet_train 3d_fullres nnUNetRandConvTrainerV2 310 0 \
     -p nnUNetPlansv2.1_general --fp32

CUDA_VISIBLE_DEVICES=2 nnUNet_def_n_proc=2 nnUNet_train 3d_fullres nnUNetBigAugTrainerV2 310 0 \
     -p nnUNetPlansv2.1_general --fp32 
