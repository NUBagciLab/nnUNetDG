...
class nnPromptEncoder(nn.Module):
    def __init__(
        self,
        embed_dim: int,
    ...
    def get_dense_pe(self):
        ...
        """
        down_level_pe = self.pe_layer(self.image_embedding_size).unsqueeze(0)
        return down_level_pe
    ...
    def forward(
        ...
        bs = self._get_batch_size(points, boxes, text_embedding)
        ...
        if text_embedding is not None:
            sparse_embeddings = torch.cat([sparse_embeddings, text_embedding], dim=1)
