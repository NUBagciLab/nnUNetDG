...
class nnUNetTrainerV2_iberm(nnUNetTrainer):
    """
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        if self.fp16:
            raise NotImplementedError("fp16 is not implemented for nnUNetTrainerV2_iberm")
        else:
            ...
            for i in range(feature.shape[0]):
                ib_penalty += feature[i].var(dim=0).mean()
            ib_penalty /= feature.shape[0]
            del data
